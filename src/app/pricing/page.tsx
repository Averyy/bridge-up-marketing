          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-xl mx-auto">
                Bridge Up is a passion project built by a solo developer. If the app saves you
                time and frustration, consider buying me a coffee to help keep it running.
              </p>

              <a
                href="https://buymeacoffee.com/bridgeup"
                target="_blank"
              ...
              <p className="mt-6 text-sm text-gray-500">
                Every coffee helps cover server costs and keeps Bridge Up free for everyone.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mt-3 text-gray-600">
                My goal is to keep Bridge Up free forever. However, if server and infrastructure
                costs grow significantly in the future, I may need to introduce optional paid
                tiers. If that happens, I&apos;ll give plenty of notice and ensure a generous free
                tier always remains available.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  a: "Our predictions use 95% confidence intervals based on the 300 most recent closures for each bridge. Most predictions are accurate within a few minutes.",
                },
                {
