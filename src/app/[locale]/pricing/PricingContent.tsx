...
export default function PricingContent() {
  ...
  const features = [
    t("features.realTimeStatus"),
    t("features.bridgesTracked"),
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-2">
                      <span className="text-6xl lg:text-7xl font-bold text-white">{t("card.price")}</span>
                      <span className="text-xl text-white/60">{t("card.priceDescription")}</span>
                    </div>
